...
public interface UserClient {
    ...
    UserProfileResponse getUserByUsername(@PathVariable("username") String username, @RequestHeader("Authorization") String authorization);

    @GetMapping("/api/users/internal/id/{id}")
    UserProfileResponse getUserById(@PathVariable("id") Long id, @RequestHeader("Authorization") String authorization);

    @PostMapping("/api/users/internal/batch")
    List<UserProfileResponse> getUsersByIds(@RequestBody List<Long> ids, @RequestHeader("Authorization") String authorization);
}